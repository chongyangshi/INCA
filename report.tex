...
\begin{tabular}{|*{8}{c|}}
\hline 
SOM Size & Data & [2 1] & [10 1] & [20 1] & [30 1] & [40 1] & [50 1] \\ \hline
\multirow{2}{*}{Training MSE} & Mean & 0.078 & 0.040 & 0.066 & 0.081 & 0.062 & 0.080 \\ \cline{2-8}
\ & Variance & \multicolumn{6}{c|}{$<$0.01} \\ \hline
\multirow{2}{*}{Validation 1 MSE} & Mean & 0.127 & 0.053 & 0.092 & 0.108 & 0.077 & 0.103 \\ \cline{2-8}
\ & Variance & \multicolumn{6}{c|}{$<$0.01} \\ \hline
\multirow{2}{*}{Misclassification 1 (\%)} & Mean & 36.5 & 6.55 & 3.69 & 5.77 & 2.59 & 3.79 \\ \cline{2-8}
\ & Variance & $<$0.01 & $<$0.01 & 0.306 & 0.535 & 0.427 & 2.18 \\ \hline
\multirow{2}{*}{Validation 2 MSE} & Mean & 0.109 & 0.055 & 0.122 & 0.140 & 0.120 & 0.146 \\ \cline{2-8}
\ & Variance & \multicolumn{6}{c|}{$<$0.01} \\ \hline
\multirow{2}{*}{Misclassification 2 (\%)} & Mean & 21.01 & 7.59 & 4.87 & 4.35 & 3.65 & 8.88 \\ \cline{2-8}
\ & Variance & $<$0.01 & $<$0.01 & 12.5 & 0.214 & 0.074 & 16.5 \\ \hline
\end{tabular}
\end{center}
\caption{\label{fig:size-testing} Results from varying network size of the one-dimensional.}
\end{figure}

\begin{figure}[h]
\begin{center}
\includegraphics[width=7.5cm]{final-testing-plot.pdf}
\end{center}
\caption{\label{fig:testing-plots} Plot showing the effect of SOM network size on the accuracy of determining the occupancy status.}
\end{figure}
